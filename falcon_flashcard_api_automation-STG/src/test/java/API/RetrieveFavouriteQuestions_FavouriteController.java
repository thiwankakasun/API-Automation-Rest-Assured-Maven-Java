...
import responseDTO.FavouriteControllerResponseDTO;
...
public class RetrieveFavouriteQuestions_FavouriteController extends ServiceController {
    ...
    private static final Logger LOGGER = Logger.getLogger(String.valueOf(RetrieveFavouriteQuestions_FavouriteController.class));
