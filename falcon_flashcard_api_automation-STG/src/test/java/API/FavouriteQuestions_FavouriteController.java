...
public class FavouriteQuestions_FavouriteController extends ServiceController {
    ...
    private static final Logger LOGGER = Logger.getLogger(String.valueOf(FavouriteQuestions_FavouriteController.class));
